...
| 035 | `adr-035-obsidian-excalidraw-minimal-workspace.md` | accepted | Obsidian dark minimalist shell, left activity ribbon, Excalidraw top floating tool capsule, removal of floating hamburger |
| 034 | `adr-034-gemini-provider-and-dynamic-model-routing.md` | accepted | Gemini provider, dynamic model route matching with active provider, and auto-select newly added nodes |
