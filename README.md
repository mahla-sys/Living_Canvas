...
npm test            # vitest run — 21 files / 263 tests, no jsdom, no extra config file
...
├── lib/__tests__/               263 tests, production code only (no fixtures that reimplement a serialiser)
