...
npm test            # vitest run — 13 files / 178 tests, no jsdom, no extra config file
...
├── lib/__tests__/               178 tests, production code only (no fixtures that reimplement a serialiser)
