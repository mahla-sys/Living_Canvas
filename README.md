...
npm test            # vitest run — 17 files / 217 tests, no jsdom, no extra config file
...
├── lib/__tests__/               217 tests, production code only (no fixtures that reimplement a serialiser)
