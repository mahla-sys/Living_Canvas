...
npm test            # vitest run — 25 files / 285 tests, no jsdom, no extra config file
...
├── lib/__tests__/               285 tests, production code only (no fixtures that reimplement a serialiser)
