...
npm test            # vitest run — 15 files / 193 tests, no jsdom, no extra config file
...
├── lib/__tests__/               193 tests, production code only (no fixtures that reimplement a serialiser)
