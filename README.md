...
npm test            # vitest run — 24 files / 283 tests, no jsdom, no extra config file
...
├── lib/__tests__/               283 tests, production code only (no fixtures that reimplement a serialiser)
