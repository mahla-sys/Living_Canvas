...
npm test            # vitest run — 26 files / 287 tests, no jsdom, no extra config file
...
├── lib/__tests__/               287 tests, production code only (no fixtures that reimplement a serialiser)
