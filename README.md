...
npm test            # vitest run — 16 files / 205 tests, no jsdom, no extra config file
...
├── lib/__tests__/               205 tests, production code only (no fixtures that reimplement a serialiser)
