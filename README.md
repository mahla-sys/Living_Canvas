...
npm test            # vitest run — 26 files / 289 tests, no jsdom, no extra config file
...
├── lib/__tests__/               289 tests, production code only (no fixtures that reimplement a serialiser)
